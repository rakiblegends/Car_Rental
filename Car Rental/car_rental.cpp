...
class Booking{//This class will perform a single rent operation
    ...
    public:
        ...
        void setRentInfo(Renter *r, int rent_id,int rent_duration,int rent_bill,int transaction_id){
            this->r = r;
            this->rent_id = rent_id;
            this->rent_duration = rent_duration;
            this->rent_bill = rent_bill;
                    ...
                    case 1:
                        {
                            ...
                            switch(sub_opt){
                                ...
                                case 3:
                                    {
                                        ...
                                        cout << "Enter rent price per hour: "; cin >> rent_price_daily;
                                ...
                                case 4:
                                    {
                                        int id;
                                        cout << "Enter the id of the car: "; cin>>id;
                                        manage.removeCar(id);
                                ...
                                case 6:{
                                    ...
                                    showRentRecords();
                                    int id;
                                    cout << "Enter id of the record to be deleted: "; cin>> id;
